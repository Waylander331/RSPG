...
[CustomEditor(typeof(EmissiveDimmer))]

public class EmissiveDimmerEditor: Editor {

	private EmissiveDimmer ld;
	void Awake(){
		ld= (EmissiveDimmer) target;
	}

	public  override void OnInspectorGUI(){
		ld.effect = (EmissiveDimmer.TypeOfEffect)EditorGUILayout.EnumPopup("Mode",ld.effect);


		GUILayout.Label("Options");
		ld.puissanceMod =  EditorGUILayout.FloatField("Modificateur Intensite", ld.puissanceMod<1f?1f:ld.puissanceMod );

		switch(ld.effect){
		
		case EmissiveDimmer.TypeOfEffect.fluorescent:
			...
			//GUILayout.
			break;
		case EmissiveDimmer.TypeOfEffect.fire:
			EditorGUILayout.LabelField("Luminosite Min:", ld.minLuminosity.ToString());
			EditorGUILayout.LabelField("Luminosite Max:", ld.maxLuminosity.ToString());
			EditorGUILayout.MinMaxSlider(ref ld.minLuminosity, ref ld.maxLuminosity, 0f, 3f);
		...
		/*	ld.minDelai =  EditorGUILayout.FloatField("Delai min", ld.minDelai );
			...
			break;
		case EmissiveDimmer.TypeOfEffect.slowPulse:
			...
			break;
		case EmissiveDimmer.TypeOfEffect.fastPulse:
			ld.pingPong = GUILayout.Toggle(ld.pingPong, "Ping Pong");
			EditorGUILayout.LabelField("Luminosite Min:", ld.minLuminosity.ToString());
			EditorGUILayout.LabelField("Luminosite Max:", ld.maxLuminosity.ToString());
			EditorGUILayout.MinMaxSlider(ref ld.minLuminosity, ref ld.maxLuminosity, 0f, 3f);
			...
			break;
		case EmissiveDimmer.TypeOfEffect.customPulse:
			ld.pingPong = GUILayout.Toggle(ld.pingPong, "Ping Pong");
